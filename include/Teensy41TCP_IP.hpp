...
void prepairTransit(uint8_t *, uint32_t, std::queue <acc> *, std::queue <acc> *, std::queue <acc> *, std::queue <int16_t> *, std::queue <int16_t> *,std::queue <int16_t> *,std::queue <int16_t> *);