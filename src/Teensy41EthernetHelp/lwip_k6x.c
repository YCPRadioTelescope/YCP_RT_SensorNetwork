...
#include "Teensy41EthernetHelp/Tlwip_k6x.h"
#include "Teensy41EthernetHelp/lwipopts.h"
...
#include "Teensy41EthernetHelp/core_pins.h"
...
void init_enet(uint32_t phy_addr_, uint8_t *mac_, ip_addr_t *ip, ip_addr_t *mask, ip_addr_t *gw)
{
    phy_addr = phy_addr_;
